...
from master.models import Module
...
class UserTokenMapping(models.Model):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='n_user', blank=True,
        null=True)
...
class UserNotificationMapping(models.Model):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='u_map', blank=True,
        null=True)
    read_status = models.BooleanField(default=False)
    app_module_name = models.ForeignKey(
        Module, on_delete=models.CASCADE, related_name='unm_module',
        blank=True, null=True)
